...
#plt.scatter(b_Trento, mult_trento/mult_trento[0]/3.1, s = 3);
plt.scatter(b_Trento, mult_trento, s = 3);
...
plt.ylabel("multiplicity [arb. unit]")
#plt.legend(loc = "best")
#plt.savefig("b-mult_optical_Glauber.pdf", format="pdf", bbox_inches="tight")
plt.savefig("b-mult_optical_Glauber_just_Trento.png", format="png", bbox_inches="tight", dpi=300)
