...
g++ -std=c++11 -lgsl -O2 -o TwoPointCentralityRandom_fixed_m analysis_two_point_centrality_random_fixed_m.cpp
./TwoPointCentralityRandom_fixed_m $DESTINATION .dat $NEVENTS
