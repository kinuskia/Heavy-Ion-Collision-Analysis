...
public:
	...
	// constructor
	Model(number_type m, number_type Q0, Collision<number_type> trento)
	: m_(m)
	, Q0_(Q0)
	, pi_(3.1415926)
	, gridmax_(10)
	...
	void set_current_index(size_type N)
	{
		current_index_ = N;
	}
	...
	number_type Event(number_type x, number_type y)
	{	
		
		number_type result = trento_.interpolate_normalized(current_index_, 1, x, y);
